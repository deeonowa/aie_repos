...
def report(
    ...
    title: str = typer.Option("# EDA-отчёт", help="Заголовок отсчета в начале report.md"),
    top_k_categories: int = typer.Option(5, help="Количество top-значений в выводе категориальных признаков"),
) -> None:
    """
